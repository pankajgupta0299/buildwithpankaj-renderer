...
const ScoreBeat = ({scene}) => {
  ...
  return <AbsoluteFill style={{background:stage==='hook'||stage==='outro'?'#20241C':'#F7F8F2',color:stage==='hook'||stage==='outro'?'#fff':'#20241C',fontFamily:'ReelHindi,Arial,sans-serif',padding:'120px 62px 180px',overflow:'hidden'}}>
