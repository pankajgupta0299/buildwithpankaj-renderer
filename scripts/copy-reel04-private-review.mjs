...
const key = 'draft-run-36014165858.mp4';
const destination = '/BUILDWITHPANKAJ/Instagram-Staging/Reel-05-Cafe-Dashboard-Charon-v1.mp4';
...
if (result.size !== bytes.length || result.name !== 'Reel-05-Cafe-Dashboard-Charon-v1.mp4') throw new Error('Private copy failed verification');
