...
const key = 'draft-run-36091746117.mp4';
const destination = '/BUILDWITHPANKAJ/Instagram-Staging/Reel-07-Guess-The-Score-Hinglish-Private-v3.mp4';
...
if (result.size !== bytes.length || result.name !== 'Reel-07-Guess-The-Score-Hinglish-Private-v3.mp4') throw new Error('Private copy failed verification');
