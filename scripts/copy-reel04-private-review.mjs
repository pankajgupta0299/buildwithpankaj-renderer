...
const key = 'draft-run-36089737611.mp4';
const destination = '/BUILDWITHPANKAJ/Instagram-Staging/Reel-07-Guess-The-Score-Hindi-Private-v1.mp4';
...
if (result.size !== bytes.length || result.name !== 'Reel-07-Guess-The-Score-Hindi-Private-v1.mp4') throw new Error('Private copy failed verification');
