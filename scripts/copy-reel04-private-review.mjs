...
const key = 'draft-run-35893728504.mp4';
const destination = '/BUILDWITHPANKAJ/Instagram-Staging/Reel-04-Doodle-Dash-Charon-v2.mp4';
...
if (result.size !== bytes.length || result.name !== 'Reel-04-Doodle-Dash-Charon-v2.mp4') throw new Error('Private copy failed verification');
