...
const key = 'draft-run-36023163561.mp4';
const destination = '/BUILDWITHPANKAJ/Instagram-Staging/Reel-06-Movie-Pitch-Charon-v1.mp4';
...
if (result.size !== bytes.length || result.name !== 'Reel-06-Movie-Pitch-Charon-v1.mp4') throw new Error('Private copy failed verification');
